 ...
 * Generated at: 2016-08-05 02:17:35 UTC
...
public final class passWdUpdate_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\tvar result= getResult(passwd);\r\n");
      out.write("\t\t\t\tif(result==1){\r\n");
      out.write("\t\t\t\t\t$(\"#ruo\").addClass(\"current\");\r\n");
      out.write("\t\t\t\t\t$(\"#zhong\").removeClass(\"current\");\r\n");
      out.write("\t\t\t\t\t$(\"#qiang\").removeClass(\"current\");\r\n");
      out.write("\t\t\t\t}else if(result==2){\r\n");
      out.write("\t\t\t\t\t$(\"#ruo\").removeClass(\"current\");\r\n");
      out.write("\t\t\t\t\t$(\"#zhong\").addClass(\"current\");\r\n");
      out.write("\t\t\t\t\t$(\"#qiang\").removeClass(\"current\");\r\n");
      out.write("\t\t\t\t}else if(result==3){\r\n");
      out.write("\t\t\t\t\t$(\"#ruo\").removeClass(\"current\");\r\n");
      out.write("\t\t\t\t\t$(\"#zhong\").removeClass(\"current\");\r\n");
      out.write("\t\t\t\t\t$(\"#qiang\").addClass(\"current\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t$(\"#passwd\").bind(\"change\",function(){\r\n");
      out.write("\t\t\t\tvar passwd=$(\"#passwd\").val().trim();\r\n");
      out.write("\t\t\t\tvar result= getResult(passwd);\r\n");
      out.write("\t\t\t\tif(result==1){\r\n");
      out.write("\t\t\t\t\t$(\"#ruo\").addClass(\"current\");\r\n");
      ...
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t$(\"#oldPasswd\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#passwd\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#secondpasswd\").val(\"\");\r\n");
      ...
      out.write("                    minlength:\"不能少于6位\",\r\n");
      out.write("                  \tmaxlength: \"最大长度100\"\r\n");
      out.write("                  },\r\n");
      out.write("                  \"secondpasswd\":{\r\n");
      out.write("                    required: \"不能为空\",\r\n");
      ...
      out.write("              \t\tvar passwd=$(\"#oldPasswd\").val();\r\n");
      out.write("              \t\t$.ajax({\r\n");
      out.write("\t\t\t\t        cache: true,\r\n");
      out.write("\t\t\t            async: false,\r\n");
      out.write("\t\t\t            dataType: 'json', \r\n");
      out.write("\t\t\t\t\t\ttype: 'GET',\r\n");
      out.write("\t\t\t            url: Domain.main+\"/member/checkPassWd.do?passwd=\"+passwd,\r\n");
      out.write("\t\t\t            success: function(flag,status){\r\n");
      out.write("\t\t\t\t            if(status==\"success\"){\r\n");
      out.write("\t\t\t\t               if(flag){\r\n");
      out.write("\t\t\t\t               \t  form.submit();\r\n");
      out.write("\t\t\t\t               }else{\r\n");
      out.write("\t\t\t\t               \t\t$(\"#oldPasswd\").addClass(\"error\");\r\n");
      out.write("\t\t\t\t               \t\t$(\"#oldPasswd\").parent().append(\"<span id='oldPasswdSpan' class='error'>旧密码错误</span>\");\r\n");
      out.write("\t\t\t\t               }\r\n");
      out.write("\t\t\t\t\t        }\r\n");
      out.write("\t\t\t\t        },\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\t\tfunction removeSpanclass(){\r\n");
      out.write("\t\t\tif($(\"#oldPasswdSpan\")){\r\n");
      out.write("\t\t\t\t$(\"#oldPasswd\").removeClass(\"error\");\r\n");
      out.write("\t\t\t\t$(\"#oldPasswdSpan\").remove();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t </script>\r\n");
      out.write("  </head>\r\n");
      ...
      out.write("    \t\t</div>\r\n");
      out.write("    \t\t<div class=\"passwd-edit\">\r\n");
      out.write("    \t\t\t<p class=\"bz-p\">\r\n");
      out.write("    \t\t\t    <span>身份验证</span>\r\n");
      out.write("    \t\t\t    <span class=\"current\">密码重置</span>\r\n");
      out.write("    \t\t\t    <span class=\"last\">完成</span>\r\n");
      out.write("    \t\t\t</p>\r\n");
      out.write("    \t\t\t<div class=\"passwd-edit-content\">\r\n");
      out.write("    \t\t\t\t<form id=\"updateForm\"  action=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${main}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/member/updatePassWd.do\" method=\"post\">\r\n");
      out.write("    \t\t\t\t    ");
      if (_jspx_meth_tag_005ftoken_005f0(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("    \t\t\t\t    <p>\r\n");
      out.write("    \t\t\t\t    \t<label>会员原密码：</label>\r\n");
      out.write("    \t\t\t\t    \t<input id=\"oldPasswd\" name=\"oldPasswd\" class=\"text\" type=\"password\" value=\"\" onblur=\"removeSpanclass();\" style=\"ime-mode:Disabled\"/>\r\n");
      out.write("    \t\t\t\t    </p>\r\n");
      out.write("    \t\t\t\t    <p>\r\n");
      out.write("    \t\t\t\t    \t<label>会员新密码：</label>\r\n");
      out.write("    \t\t\t\t    \t<input id=\"passwd\" name=\"passwd\" class=\"text\" type=\"password\" value=\"\" style=\"ime-mode:Disabled\"/>\r\n");
      out.write("    \t\t\t\t    </p>\r\n");
      out.write("    \t\t\t\t    <p class=\"passwd-level\">\r\n");
      out.write("    \t\t\t\t    \t<i id=\"ruo\" class=\"ruo\">弱</i>\r\n");
      out.write("    \t\t\t\t    \t<i id=\"zhong\" class=\"zhong\">中</i>\r\n");
      out.write("    \t\t\t\t    \t<i id=\"qiang\" class=\"qiang\">强</i>\r\n");
      out.write("    \t\t\t\t    </p>\r\n");
      out.write("    \t\t\t\t    <p>\r\n");
      out.write("    \t\t\t\t    \t<label>再次输入：</label>\r\n");
      out.write("    \t\t\t\t    \t<input id=\"secondpasswd\" name=\"secondpasswd\"  class=\"text\" type=\"password\" style=\"ime-mode:Disabled\"/>\r\n");
      out.write("    \t\t\t\t    \t<span></span>\r\n");
      out.write("    \t\t\t\t    </p>\r\n");
      out.write("    \t\t\t\t    <p class=\"last-p\">\r\n");
      out.write("    \t\t\t\t    \t<input  class=\"btn\" type=\"button\" name=\"提交\" onclick=\"commitForm()\"/>\r\n");
      out.write("    \t\t\t\t    </p>\r\n");
      out.write("    \t\t\t\t</form>\r\n");
      out.write("    \t\t\t</div>\r\n");
      out.write("    \t\t\t<p class=\"alter-info\">\r\n");
      out.write("    \t\t\t\t此密码是您登录系统时使用。如果忘记可以通过您注册时使用的邮箱或手机找回。\r\n");
      out.write("    \t\t\t</p>\r\n");
      out.write("    \t\t</div>\r\n");
      out.write("      </div>\r\n");
      out.write("      <div style=\"clear:both;\"></div>\r\n");
