 ...
 * Generated at: 2016-08-11 02:42:13 UTC
...
public final class realNameCheckOne_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("    \t\tmemberModule(\"smrz\");\r\n");
      out.write("        \t$(\"#checkbox\").bind(\"click\",function(){\r\n");
      out.write("        \t\tif($(\"#checkbox\").eq(0).is(\":checked\")){\r\n");
      out.write("        \t\t\t$(\"#checkbox\").eq(0).attr(\"checked\",\"checked\");\r\n");
      out.write("        \t\t}else{\r\n");
      out.write("        \t\t\t$(\"#checkbox\").eq(0).attr(\"checked\",false);\r\n");
      out.write("        \t\t}\r\n");
      out.write("        \t});\r\n");
      out.write("        })\r\n");
      out.write("     \tfunction submitForm(button){\r\n");
      out.write("     \t\tif($(\"#checkbox\").eq(0).is(\":checked\")){\r\n");
      out.write("     \t\t\t$(button).closest(\"form\").submit();\r\n");
      out.write("     \t\t}else{\r\n");
      out.write("     \t\t\talert(\"请先阅读协议！\");\r\n");
      out.write("     \t\t}\r\n");
      out.write("     \t}\r\n");
      out.write("     </script>\r\n");
      out.write("  </head>\r\n");
      ...
      out.write("    \t\t\t<a href=\"#\">&gt;&gt;</a>\r\n");
      out.write("    \t\t\t<a href=\"#\">实名认证</a>\r\n");
      out.write("    \t\t</div>\r\n");
      out.write("    \t\t<div class=\"cert-apply\">\r\n");
      out.write("    \t\t\t<p class=\"bz-text\">\r\n");
      out.write("    \t\t\t\t<span class=\"current\">实名认证申请</span>\r\n");
      out.write("    \t\t\t\t<span>填写实名信息</span>\r\n");
      out.write("    \t\t\t\t<span class=\"last\">完成</span>\r\n");
      out.write("    \t\t\t</p>\r\n");
      out.write("    \t\t\t<div class=\"cert-apply-content\">\r\n");
      out.write("    \t\t\t\t<p>实名认证是由航天易卡提供的一项身份识别服务。通过航天易卡实名认证，您就相当于拥有了一张互联网身份证，增加您的信任度。</p>\r\n");
      out.write("    \t\t\t\t<p class=\"p2\">实名认证前，您需要：</p>\r\n");
      out.write("    \t\t\t\t<p>持有居民身份证，台胞证或护照等有效证件。</p>\r\n");
      out.write("    \t\t\t\t<p>持有航天易卡IC卡，该卡您可以在我们公司的各大营业厅进行购买。</p>\r\n");
      out.write("    \t\t\t\t<p class=\"p2\">实名认证后，您可以：</p>\r\n");
      out.write("    \t\t\t\t<p>绑定航天易卡IC卡。</p>\r\n");
      out.write("    \t\t\t\t<p>提高账户安全等级。</p>\r\n");
      out.write("    \t\t\t\t<p class=\"agree\">\r\n");
      out.write("    \t\t\t\t\t<input type=\"checkbox\"  id=\"checkbox\"/><span>我已阅读并同意</span><a href=\"#\">《航天易卡实名认证服务协议》</a>\r\n");
      out.write("    \t\t\t\t</p>\r\n");
      out.write("    \t\t\t\t<form id=\"updateForm\"  action=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${main}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/member/linkRealNameCheckTwo.do\" method=\"get\">\r\n");
      out.write("    \t\t\t\t<p class=\"last\">\r\n");
      out.write("    \t\t\t\t\t\r\n");
      out.write("    \t\t\t\t\t\t<input class=\"btn-cert\" type=\"button\" value=\"\" onclick=\"submitForm(this)\" />\r\n");
      out.write("    \t\t\t\t\t\r\n");
      out.write("    \t\t\t\t</p>\r\n");
      out.write("    \t\t\t\t</form>\r\n");
      out.write("    \t\t\t</div>\r\n");
      out.write("    \t\t</div>\r\n");
      out.write("            <textarea rows=\"7\" cols=\"120\" readonly=\"readonly\" style=\"line-height:25px;text-indent:30px;width:650px;margin-left:50px;\">\r\n");
      out.write("\t\t               航天支付实名认证服务协议\r\n");
      out.write("　　 浙江航天电子信息产业有限公司（以下简称“航天电子”）依据本协议的规定为您提供服务。请您确认，在开始“航天支付网站实名认证”（以下简称实名认证）前，已详细阅读、充分理解并同意接受本协议的全部内容。\r\n");
      out.write("\r\n");
      out.write("一、关于服务协议的确认\r\n");
      out.write("　　一）、航天支付服务是由航天电子向用户提供的电子商务软件服务系统。在您申请实名认证前，您必须先注册成为航天支付用户。\r\n");
      out.write("    二）、航天电子的最新服务协议及使用说明将通过航天支付网站公布，不另作通知。若您于任何修改或变更本服务条款后继续使用本服务，则视为您已阅读、了解并同意接受修改或变更。 \r\n");
      out.write("\r\n");
      out.write("二、身份认证\r\n");
      out.write("　　一）、航天支付个人用户提供以下证件用于实名认证：认证当时处在有效期内的身份证、护照等明确标有身份证号的证件之一。\r\n");
      out.write("　  二）、法律规定不具有完全民事行为能力的自然人，航天电子不向其提供实名认证服务。\r\n");
      out.write("　  三）、通过身份信息识别的个人用户不能自行修改已经认证的信息，包括但不限于姓名以及身份证件号码等。\r\n");
      out.write("　  四）、在个人用户对其航天支付账户进行取回密码等操作时，需要按照航天电子的提示出示可确认其持有该账户的个人身份证件等相关证件进行核实。\r\n");
      out.write("　　五）、航天电子有权对用户的身份进行识别。航天电子有权记录并保存您完成实名认证时，提供的信息亦有权根据本协议的约定向您或第三方提供您是否通过认证的结论以及您的身份信息。\r\n");
      out.write("\r\n");
      out.write("三、银行账户识别\r\n");
      out.write("　  一）、个人用户进行认证应提供本人在大陆银行开设的人民币账号、开户名、开户银行。\r\n");
      out.write("　　二）、商户类用户应提供其在大陆银行开设的人民币账号、开户名、开户银行。\r\n");
      out.write("　  三）、用户填写的银行账户的开户名必须与身份信息中的真实姓名完全一致，所有经用户填写的资料将成为实名认证资料。\r\n");
      out.write("　  四）、若用户尚不具备完全民事行为能力，而以提供不实认证资料的方式，使本公司误认为该用户是完全民事行为能力人而受理身份信息识别申请的，则因此产生的一切后果将由该用户及(或)其监护人承担，本公司不承担任何责任。\r\n");
      out.write("   \r\n");
      out.write("四、认证资料的管理：\r\n");
      out.write("　　　您在认证时提交给航天电子的认证资料，即不可撤销的授权由航天电子保留。航天电子承诺除法定或约定的事由外，不公开透露您的认证资料及保存在航天电子的非公开内容用于商业目的，但以下情形除外：\r\n");
      out.write("　　1、您授权航天电子透露的相关信息；\r\n");
      out.write("　　2、航天电子向国家司法及行政机关提供；\r\n");
      out.write("　　3、第三方和航天电子一起为用户提供服务时，该第三方向您提供服务所需的相关信息（不包括您的银行账户信息）。\r\n");
      out.write("　　4、基于解决您与第三方民事纠纷的需要，航天电子有权向该第三方提供您的身份信息。\r\n");
      out.write("　　5、依政府部门的要求的情况。\r\n");
      out.write("　　　\r\n");
      out.write("五、不得为非法或禁止的使用\r\n");
      out.write("　　接受本协议全部的说明、条款、条件是您申请实名认证的先决条件。您声明并保证，您不得为任何非法或为本协议、条件及须知所禁止之目的进行认证申请。您不得以任何可能损害、使过度负荷或损害其他网站或其他网站的服务等方式使用实名认证服务。\r\n");
      out.write("   \r\n");
      out.write("六、有关免责\r\n");
      out.write("　　下列情况时航天电子无需承担任何责任：\r\n");
      out.write("　　一）、由于您将航天支付账户密码告知他人或未保管好自己的密码或与他人共享账户或任何其他非航天电子的过错，导致您的个人资料泄露。\r\n");
      out.write("　　二）、系统因下列状况无法正常运作，使用户无法使用各项服务时，包括但不限于： \r\n");
      out.write("    1、电子商务系统停机维护期间。 \r\n");
      out.write("    2、电信设备出现故障不能进行数据传输的。 \r\n");
      out.write("    3、因台风、地震、海啸、洪水、停电、战争、恐怖袭击等不可抗力之因素，造成电子商务系统障碍不能执行业务的。 \r\n");
      out.write("　　三）、任何个人用户（包括未成年人用户）向航天电子提供错误、不完整、不实信息等造成不能通过认证或遭受任何其他损失，概与航天电子无关。   \r\n");
      out.write("七、服务条款的解释、法律适用及争端解决 \r\n");
      out.write("　　一）、本协议将受国家法律、法规管辖，如果本协议与国家的法律、法规有冲突的，将按照国家法律、法规的规定执行。\r\n");
      out.write("　　二）、因本协议所引起的用户与航天电子的任何纠纷或争议，首先应友好协商解决，协商不成的，用户可将纠纷或争议提交协议签署地的人民法院诉讼解决。\r\n");
      out.write("　　三）、航天电子对本服务条款拥有最终的解释权。</textarea>\r\n");
      out.write("      </div>\r\n");
      out.write("      <div style=\"clear:both;\"></div>\r\n");
      out.write("    </div>\r\n");
      out.write("    ");
